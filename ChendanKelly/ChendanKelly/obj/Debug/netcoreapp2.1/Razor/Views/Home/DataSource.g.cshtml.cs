#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a6e3a85e4d0c562dd7c3aa5844deea5cd9dd5f58"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a6e3a85e4d0c562dd7c3aa5844deea5cd9dd5f58", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
        ...
        $(""#file-picker"").change(function (e) {
            ...
            if (file != undefined && file.name != undefined) {
                if (file.name.includes('fee_')) {
                    ...
                    uploadFeeFileCallback(file, dateStr);
                }
            ...
            WriteLiteral(@"des('price_')) {
                ...
                if (file.name.includes('日订单报表')) {
                    ...
                    let dayNumber = file.name.split('月')[1].split('日')[0];
                    let dateStr = year + '-' + monthNumber + '-' + dayNumber;
                    uploadOrderFileCallback(file, dateS");
            WriteLiteral(@"tr);
                }
            }
        });
        ...
        reader.onload = function () {
            try {
                ...
                for (let i = 0; i < fileJson.length; i++) {
                    let orderId = fileJson[i][""订单编号""] ");
            WriteLiteral(@"== undefined ? fileJson[i][""\""订单编号\""""] : fileJson[i][""订单编号""];
    ...
    function uploadOrderFileCallback(file, date) {        
        ...
        reader.onload = function () {
            try {
                ...
                debugger;
                for (let i = 0; i < fileJson.length; i++) {
                    let orderId = fileJson[i][""订单编号""] == undefined ? fileJson[i][""\""订单编号\""""] : fileJson[i][""订单编");
            WriteLiteral(@"号""];
    ...
    function uploadShouruFileCallback(file, date) {
        ...
        reader.onload = function () {
            try {
                ...
                debugger;
                for (let i = 0;");
            WriteLiteral(@" i < fileJson.length; i++) {
    ...
    function uploadUnitPriceFileCallback(file, date) {
        ...
        reader.onload = function () {
            try {
                ...
                debugger;
     ");
            WriteLiteral(@"           for (let i = 0; i < fileJson.length; i++) {
    ...
    function refreshFileGrid() {
        agGrid.simpleHttpRequest({ url: '/DataSource/GetAllFiles' }).then(function (data) {
            let newData = [];
     ");
            WriteLiteral(@"       for (let i = 0; i < data.length; i++) {
            ...
            WriteLiteral(@"e);
                ...
                case 'Fee':
                    ...
                    agGrid.simpleHttpRequest({ url: '/DataSource/GetFees?date=' + state.selectionRow.date }).then(function (data) {
                        loading(false);
             ");
            WriteLiteral(@"           datasourceGridOptions.api.setRowData(data);
                    });
                    break;
                case 'Price':
                    datasourceGridOptions.api.setColumnDefs([
                    ...
                    break;
                case 'Settle':
                    datasourceGridOptions.api.setColumn");
            WriteLiteral(@"Defs([
                        {
                            headerName: ""订单编号"", field: ""orderId""
                        },
    ...
    function uploadPrice(date, jsonValue, fileName) {
        fetch('/DataSource/InsertDataToPriceTable', {
            ...
            body: JSON.stringify({ date, newPri");
            WriteLiteral(@"ces: jsonValue, fileName })
        }).then(e => {
            loading(false);
            if (e.status === 200) {
                refreshFileGrid();
    ...
    function uploadOrder(dat");
            WriteLiteral(@"e, jsonValue, fileName) {
    ...
    function deleteSelectedItems() {
        if (state.selectionRow != null) {
            ...
            els");
            WriteLiteral(@"e if (state.selectionRow.fileType == 'Price') {
