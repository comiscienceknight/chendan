#pragma checksum "C:\Projects\ChendanKelly\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2a00f367b86e06ac55f183c155abf5f3c037f89c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2a00f367b86e06ac55f183c155abf5f3c037f89c", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    va");
            WriteLiteral(@"r fileGridOptions = {
    ...
    function uploadBaobeiFile() {
        ...
        $(""#file-picker"").change(function (e) {
            if (s");
            WriteLiteral(@"tate.selectedFileType === 'Baobei') {
                state.selectedFileType = '';
                uploadBaobeiFileCallback(e, $('#file-date-picker')[0].value);
            }
        });
    }
    function uploadBaobeiFileCallback(e, date) {
        let file = e.currentTarget.files[0];
        document.getElementById(""file-date-picker"").value = """";
        if (file === undefined) {
            return;
        }
        ...
        reader.onload = function () {
            try {
                ...
                for (let i = 0; i < fileJson.length; i++) {
                    ...
                    let quantity = fileJson[i][""购买数量""] == undef");
            WriteLiteral(@"ined ? fileJson[i][""\""购买数量\""""] : fileJson[i][""购买数量""];
    ...
    function uploadOrderFile() {
        ...
        $(""#file-picker"").change(function (e) {
            if (state.selectedFileType === 'Order') {
                state.selectedFileType = '';
                uploa");
            WriteLiteral(@"dOrderFileCallback(e);
            }
        });
    }
    function uploadOrderFileCallback(e) {
        let file = e.currentTarget.files[0];
        document.getElementById(""file-date-picker"").value = """";
        if (file === undefined) {
            return;
        ...
        reader.onload = function () {
            try {
             ...
             ");
            WriteLiteral(@"   uploadOrder($('#file-date-picker')[0].value, newOrders, file.name);
            }
            catch{
                alert('上传文件失败');
                loading(false);
    ...
    function uploadFeeFile() {
        ...
        $(""#file-picker"").change(function (e) {
            if (state.selectedFileType === 'Fee') {
                state.selectedFileType = '';
                uploadFeeFileCallback(e, $('#file-date-picker')[0].value);
            }
        });
    }
    function uploadFeeFileCallback(e, date) {
        let file = e.currentTarget.files[0];
        document.getElementById(""file-date-picker"").value = """";
        if (file === undefined) {
            return;
        ...
        reader.onload = function () {
            try {
                loading(true);
                var fileJson = csvJSON(reader.resul");
            WriteLiteral(@"t);
                debugger;
                let newFees = [];
                for (let i = 0; i < fileJson.length; i++) {
    ...
    function uploadShouruFile() {
        ...
        $(""#file-picker"").change(function (e) {
            if (state.selectedFi");
            WriteLiteral(@"leType === 'Shouru') {
                state.selectedFileType = '';
                uploadShouruFileCallback(e, $('#file-date-picker')[0].value);
            }
        });
    }
    function uploadShouruFileCallback(e, date) {
        let file = e.currentTarget.files[0];
        document.getElementById(""file-date-picker"").value = """";
        if (file === undefined) {
            return;
        ...
        reader.onload = function () {
            try {
                ...
                for (let i = 0; i < fileJson.length; i++) {
                    ...
                    if (amou");
            WriteLiteral(@"nt != undefined && amount !== null)
                        amount = amount.trim()
    ...
    function uploadUnitPriceFile() {
        ...
        $(""#file-picker"").change(function (e) {
            if (state.selectedF");
            WriteLiteral(@"ileType === 'UnitPrice') {
                state.selectedFileType = '';
                uploadUnitPriceFileCallback(e);
            }
        });
    }
    function uploadUnitPriceFileCallback(e) {
        let file = e.currentTarget.files[0];
        document.getElementById(""file-date-picker"").value = """";
        if (file === undefined) {
            return;
    ...
    function onFileGridSelectionChanged() {
        var selectedRows =");
            WriteLiteral(@" fileGridOptions.api.getSelectedRows();
        ...
        if (state.selectionRow != null) {
            switch (state.selectionRow.fileType) {
                case 'Baobei':
                    ...
                    loading(true);
                    agG");
            WriteLiteral(@"rid.simpleHttpRequest({ url: '/DataSource/GetBaobeis?date=' + state.selectionRow.date }).then(function (data) {
                        loading(false);
                ...
                case 'Fee':
                    datasou");
            WriteLiteral(@"rceGridOptions.api.setColumnDefs([
                        {
                ...
                case 'Price':
                    datasourceGridOptions.api.setColumnDefs([
                        ...
                        {
       ");
            WriteLiteral(@"                     headerName: ""宝贝标题"", field: ""baobeiTitle""
                        },
                        {
    ...
    function uploadFee(date, jsonValue, fileName) {
        fetch('/DataSource/InsertDataToFeeTable', {
            ...
            body: JSON.stringify({ date, newFees: jsonValu");
            WriteLiteral(@"e, fileName })
        }).then(e => {
            loading(false);
            if (e.status === 200) {
                refreshFileGrid();
    ...
    function uploadBaobei(date, jsonValue, f");
  ...
  ");
    ...
    function csvJSON(csv, path) {
        ...
        for (var i = 1; i < lines.length; i++) {
            ...
            for (var j");
            WriteLiteral(@" = 0; j < headers.length; j++) {
