#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "77786e4f9125dcbb20243cf0a8a9ef3e839743a8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"77786e4f9125dcbb20243cf0a8a9ef3e839743a8", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    function uploadBaobeiFile() {
        state.selec");
            WriteLiteral(@"tedFileType = 'Baobei';
        $('#file-picker').click();
...
");
            WriteLiteral(@"                            headerName: ""总金额"", field: ""amount""
                ...
                case 'Fee':
                    ...
                    loading(true);
                    agGrid.simpleHttpReq");
            WriteLiteral(@"uest({ url: '/DataSource/GetFees?date=' + state.selectionRow.date }).then(function (data) {
                        loading(false);
                        datasourceGridOptions.api.setRowData(data);
                    });
                    break;
                case 'Price':
                    ...
                    agGrid.simpleHttpRequest({ url: '/DataSource/GetPrices?date=' + state.selectionRow.date }).then(function (data) {
                        loading(false);
                        datasourceGridOptions.api.setRowData(d");
            WriteLiteral(@"ata);
                    });
                    break;
                case 'Settle':
...
");
    ...
    function deleteSelectedItems() {
        if (state.selectionRow != null) {
            ...
            els");
            WriteLiteral(@"e if (state.selectionRow.fileType == 'Fee') {
