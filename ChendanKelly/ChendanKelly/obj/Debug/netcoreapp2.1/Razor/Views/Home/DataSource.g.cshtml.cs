#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4514ac931334c0e32123c8691b7b63cdb30f61d0"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4514ac931334c0e32123c8691b7b63cdb30f61d0", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    var fileGridColumnDefs = [
        {
            headerName: ""Date"", field: ""date"", width: 90, rowGroup: true
        },
        {
   ...
   ");
                ...
                reader.onload = function () {
                    try {
                        ...
                        for (let i = 0; i < fileJson.length; i++) {
                            ...
                            let quantity = fileJson[i][""购买数量""] == undefined ? fileJson[i][""\""购买数量\""""] : fileJs");
            WriteLiteral(@"on[i][""购买数量""];
                    ...
                    try {
                        ...
                        for (let i = 0; i < fileJson.length; i++) {
                            ...
                            newOrders.push({
                                orderId: clearSlash(orderId),
                          ");
            WriteLiteral(@"      amount: clearSlash(amount),
                            });
                        }
            ...
            if (state.selectedFileType === 'Fee') {
                ...
                reader.onload = function () {
                    try {
                        loading(true);
          ");
            WriteLiteral(@"              var fileJson = csvJSON(reader.result);
                        debugger;
                        let newFees = [];
                        for (let i = 0; i < fileJson.length; i++) {
                ...
                rea");
            WriteLiteral(@"der.readAsText(file, 'utf-8');
            }
        });
    }
            ...
            if (state.selectedFileType === 'Shouru') {
                ...
                reader.onload = function () {
                    try {
                       ...
                       ");
            WriteLiteral(@"     let settleAmount = fileJson[i][""Settlement""];
            ...
            if (state.selectedFileType === 'UnitPrice') {
                ...
                reader.onload = function () {
                    try {
                        ...
                        debugger;
                        for (let i = 0; i < fileJson.length; i++) {
                            let baobeiId = fileJson[i");
            WriteLiteral(@"][""BaobeiId""];
    ...
    function refreshFileGrid() {
        agGrid.simpleHttpReques");
            WriteLiteral(@"t({ url: '/DataSource/GetAllFiles' }).then(function (data) {
            let newData = [];
        ...
        if (state.selectionRow != null) {
            switch (state.selectionRow.fileType) {
                case 'Baobei':
                    ...
                    datasourceGridOptions.api.setColumnDefs([
                        ...
                        {
                            h");
            WriteLiteral(@"eaderName: ""外部系统编号"", field: ""baobeiExternalId""
                        },
                        {
         ...
         ");
            WriteLiteral(@"               loading(false);
                ...
                case 'Settle':
          ");
            WriteLiteral(@"          datasourceGridOptions.api.setColumnDefs([
                        {
                            headerName: ""订单编号"", field: ""orderId""
                        },
                        {
   ...
   ");
            WriteLiteral(@"         datasourceGridOptions.api.setRowData([]);
        }
    }
  ...
  ");
            WriteLiteral(@"          body: JSON.stringify({ date, newPrices: jsonValue, fileName })
        }).then(e => {
            loading(false);
            if (e.status === 200) {
                refreshFileGrid();
    ...
    function deleteSelectedItems() {
        if (state.selectionRow != null) {
            ...
            if (state.selectionRow.fileType == 'Order') {
                ...
                fetchUrl = fetchUrl + 'DeleteDataFromFe");
            WriteLiteral(@"eTableAsync';
            }
