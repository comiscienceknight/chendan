#pragma checksum "C:\Projects\ChendanKelly\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a15b9ce93956ab2ade901e27949d401fedc08fb8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a15b9ce93956ab2ade901e27949d401fedc08fb8", @"/Views/Home/DataSource.cshtml")]
...
<script src=""https://cdnjs.cloudflare.c");
            WriteLiteral(@"om/ajax/libs/xlsx/0.8.0/xlsx.js""></script>
...
<script type=""text/javascript"" charset=""utf-8"">
 ...
 ");
            WriteLiteral(@"   var datasourceGrid = document.querySelector('#datasourceGrid');
 ...
 ");
            WriteLiteral(@"                   let quantity = fileJson[i][""购买数量""] == undefined ? fileJson[i][""\""购买数量\""""] : fileJson[i][""购买数量""];
        ...
        ");
            WriteLiteral(@"                partnerOrderId,
                ...
                uploadPrice($('#file-date-picker')[0].v");
            WriteLiteral(@"alue, newPrices, file.name);
            }
            else {
                alert('这个文件不能被识别');
            }
          ...
          ");
            WriteLiteral(@"              },
                ...
                case 'Fee':
                    ...
                    agGrid.simpleHttpRequest({ url: '/DataSource/GetFees?date=' + selectionRow.date }).then(functi");
            ...
            datasourceGridOption");
            WriteLiteral(@"s.api.setColumnDefs([
            ]);
    ...
    function deleteSelectedItems() {
      ...
      ");
            WriteLiteral(@"      else if (selectionRow.fileType == 'Baobei') {
