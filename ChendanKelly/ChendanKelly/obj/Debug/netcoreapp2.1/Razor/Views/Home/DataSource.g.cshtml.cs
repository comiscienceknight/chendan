#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d95be48ebe860519eaf3770c5ce33b9126d04432"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d95be48ebe860519eaf3770c5ce33b9126d04432", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    var datasourceGrid = document.querySelector('#datasourceG");
            WriteLiteral(@"rid');
        ...
        reader.onload = function () {
            ...
            if (fileJson.length > 0 && orderId !== undefined && baobeiId === undefined && partnerOrderId === undefined) {
                ...
                for (let i = 0; i < fileJson.length; i++) {
                    let orderId = fileJson[i][""订单编号""] == undefined ? fileJson[i][""\""订");
            WriteLiteral(@"单编号\""""] : fileJson[i][""订单编号""];
                ...
                for (let i = 0; i < fileJson.length; i++) {
                    ...
                    let ");
            WriteLiteral(@"baobeiTitle = fileJson[i][""标题""] == undefined ? fileJson[i][""\""标题\""""] : fileJson[i][""标题""];
                    newBaobeis.push({
                        orderId: orderId,
                        baobeiExternalId,
                        quantity,
