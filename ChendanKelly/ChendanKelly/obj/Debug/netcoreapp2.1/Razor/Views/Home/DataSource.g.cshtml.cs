#pragma checksum "C:\Projects\ChendanKelly\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "69a7fc2d3c61e8bf90e18406c75df1dbb4574f69"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"69a7fc2d3c61e8bf90e18406c75df1dbb4574f69", @"/Views/Home/DataSource.cshtml")]
...
");
            WriteLiteral(@"                            let baobeiTitle = fileJson[i][""BaobeiTitle""];
    ...
    function refreshFileGrid() {
        agGrid.simpleHttpRequest({ url: '/DataS");
            WriteLiteral(@"ource/GetAllFiles' }).then(function (data) {
            let newData = [];
            ...
            switch (state.selectionRow.fileType) {
                case 'Baobei':
                    ...
                    datasourceGridOptions.api.setColumnDefs([
                        ...
                        {
                            headerName: ""外部系统");
            WriteLiteral(@"编号"", field: ""baobeiExternalId""
                        },
                        {
  ...
  ");
            ...
            WriteLiteral(@"oading(false);
                ...
                case 'Settle':
                    dataso");
            WriteLiteral(@"urceGridOptions.api.setColumnDefs([
                        {
                            headerName: ""订单编号"", field: ""orderId""
                        },
                        {
            ...
            datasou");
            WriteLiteral(@"rceGridOptions.api.setRowData([]);
        }
    }
    ...
    function uploadPrice(date, jsonValue, fileName) {
        fetch('/DataSource/InsertDataToPriceTable', {
            ...
            body: ");
            WriteLiteral(@"JSON.stringify({ date, newPrices: jsonValue, fileName })
        }).then(e => {
            loading(false);
            if (e.status === 200) {
                refreshFileGrid();
