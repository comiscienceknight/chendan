#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8c606f0cc3c05cd7db8746476ebea918be64c1a7"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8c606f0cc3c05cd7db8746476ebea918be64c1a7", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    $(""#file-picker"").change(function (e) {
        ...
        reader.onload = function () {
            ...
            WriteLiteral(@"           quantity,
                ...
                uploadBaobei($('#file-date-picker')[0].value, newBaobeis);
            }
        };
    ...
    function uploadBaobei(date, jsonValue) {
        fetch('/DataSource/I");
            WriteLiteral(@"nsertDataToBaobeiTable', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
            },
            body: JSON.stringify({ date, newBaobeis: jsonValue })
        }).then(e => {
            if (e.status === 200) {
                refreshFileGrid();
            }
