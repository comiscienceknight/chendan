#pragma checksum "C:\Projects\Beau.Fullstack\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7a7e8565dfdc700a3b992bf6e4eb394363bac769"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7a7e8565dfdc700a3b992bf6e4eb394363bac769", @"/Views/Home/DataSource.cshtml")]
        ...
        $(""#file-picker"").change(function (e) {
            ...
            WriteLiteral(@"des('price_')) {
                ...
                if (file.name.includes('日订单报表')) {
                    ...
                    let dayNumber = file.name.split('月')[1].split('日')[0];
                    let dateStr = year + '-' + monthNumber + '-' + dayNumber;
                    uploadBaobeiFileCallback(file, date");
            WriteLiteral(@"Str);
                }
            }
        });
    ...
    function uploadOrderFileCallback(file, date) {        
        ...
        reader.onload = function () {
            try {
                ...
                debugger;
                for (let i = 0; i < fileJson.length; i++) {
                    let orderId = fileJson[i][""订单编号""] == undefined ? fileJson[i][""\""订单编号\""""] : fileJson[i][""订单");
            WriteLiteral(@"编号""];
