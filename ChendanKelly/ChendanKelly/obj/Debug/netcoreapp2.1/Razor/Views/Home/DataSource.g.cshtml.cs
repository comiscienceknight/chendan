#pragma checksum "C:\Projects\ChendanKelly\chendan\ChendanKelly\ChendanKelly\Views\Home\DataSource.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3d1abf054868109ba52761b40191cc0230bac16b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3d1abf054868109ba52761b40191cc0230bac16b", @"/Views/Home/DataSource.cshtml")]
...
<script type=""text/javascript"" charset=""utf-8"">
    ...
    var fil");
            WriteLiteral(@"eGrid = document.querySelector('#fileGrid');
    ...
    function uploadBaobeiFile() {
        ...
        $('#file-picker').click();
    ");
            WriteLiteral(@"    $(""#file-picker"").change(function (e) {
...
");
            WriteLiteral(@"                            let baobeiTitle = fileJson[i][""标题""] == undefined ? fileJson[i][""\""标题\""""] : fileJson[i][""标题""];
                            newBaobeis.push({
            ...
            if (state.selectedFileType === 'Fee') {
                ...
                reader.onload = function () {
                    try {
                        loading(true);
                        va");
            WriteLiteral(@"r fileJson = csvJSON(reader.result);
                        debugger;
                        let newFees = [];
                        for (let i = 0; i < fileJson.length; i++) {
                ...
                reader.onload = function () {
                    try {
                        ...
                        for (let i = 0; i < fileJson.length; i++) {
                            ...
                            let settleA");
            WriteLiteral(@"mount = fileJson[i][""Settlement""];
                ...
                reader");
            WriteLiteral(@".readAsText(file, 'gb2312');
            }
        });
    }
        ...
        $(""#file-picker"").change(function (e) {
            if (state.selectedFileType === 'UnitPrice') {
                ...
                reader.onload = function () {
                    ...
                    ");
            WriteLiteral(@"        let unitPriceInEuro = fileJson[i][""UnitPriceInEuro""];
            ...
            switch (state.selectionRow.fileType) {
                case 'Baobei':
                    ...
                    datasourceGridOptions.api.setColumnDefs([
                        ...
                        {
        ");
            WriteLiteral(@"                    headerName: ""购买数量"", field: ""quantity""
                        },
                        {
                ...
                case 'Order':
                    ...
                    loading(true);
                    agGrid.simpleHttpRequest({ url: '/DataSou");
            WriteLiteral(@"rce/GetOrders?date=' + state.selectionRow.date }).then(function (data) {
                        loading(false);
                        datasourceGridOptions.api.setRowData(data);
                    });
                    break;
            ...
            WriteLiteral(@"          });
                ...
                case 'Settle':
                    datasourceGridOptions.api.setColumnDefs([
                        {
                            hea");
            WriteLiteral(@"derName: ""订单编号"", field: ""orderId""
                        },
                        {
    ...
    function uploadFee(date, jsonValue,");
    ...
    function uploadOrder(date, jsonValue, fileName) {
        fetch('/DataSource/InsertDataTo");
            WriteLiteral(@"OrderTable', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    function deleteSelectedItems() {
        if (state.selectionRow != null) {
            ...
            if (state.selectionRow.fileType == 'Order') {
                ...
                f");
            WriteLiteral(@"etchUrl = fetchUrl + 'DeleteDataFromPriceTableAsync';
            }
 ...
 ");
            WriteLiteral(@"   function csvJSON(csv, path) {
        var lines = csv.split(""\n"");
        var result = [];
